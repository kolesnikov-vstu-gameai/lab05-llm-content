...
2. Отчёт пишите в `docs/report.md` (черновик по разделам, 6–8 стр.), затем перенесите в официальный шаблон отчёта, принятый на кафедре, и экспортируйте в PDF (`docs/report.pdf`).
